    ...
    <div id="page-wrapper" >
        <table class="layui-table" lay-data="{width: 850, height:400, url: '${pageContext.request.contextPath}/tablecolsServlet', page:true, id:'idTest'}" lay-filter="demo">
            ...
            <tr>
                ...
                <th lay-data="{field:'title', width:500, sort: true, fixed: true}">标题</th>
                <th lay-data="{fixed: 'right', width:298, align:'center', toolbar: '#barDemo'}">操作</th>
            </tr>
            </thead>
            <script type="text/html" id="barDemo">
                <a class="layui-btn layui-btn-xs" lay-event="edit">内容</a>
   ...
   %>
    layui.use('table', function(){
        ...
        table.on('tool(demo)', function(obj){
            var data = obj.data;
            if(obj.event === 'detail'){
                layer.msg('ID：'+ data.colname + ' 的查看操作');
